...
const ProductItem = ({ item }) => {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <button className="flex justify-center rounded-lg bg-cyan-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-cyan-800 focus:outline-none focus:ring-4 focus:ring-cyan-300 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800  group-hover:opacity-100" onClick={()=> addItem(item, id)}>Add to Cart</button>
    </div>
  )
}
