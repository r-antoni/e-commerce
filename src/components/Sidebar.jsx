...
const Sidebar = () => {
  ...
  return (
    <div className={`${open ? "right-0" : "-right-full"} fixed top-0 bg-white h-full w-[500px] rounded transition-all z-10 shadow-2xl`}>
      ...
      <div className={cart.length === 0 ? "hidden" : "w-full flex justify-between px-10 pt-8 text-sm font-medium uppercase border-t"}>
        <div className='py-2'>
