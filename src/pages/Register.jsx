    ...
    <div className="flex">
      ...
      <form className="flex w-80 flex-col gap-4 justify-center">
        <div>
          ...
          <TextInput id="email2" placeholder="name@flowbite.com" required shadow type="email" />
        </div>
        <div>
          <div className="mb-2 block">
        ...
        <div className="flex items-center gap-2">
          ...
          <Label className="flex" htmlFor="agree">
            <p>
              I agree with the{" "}
              <span className="text-cyan-600 hover:underline dark:text-cyan-500">terms and conditions</span>
            </p>
          </Label>
        </div>
        ...
        <p className="text-sm">
          Have an account ?{" "}
          <Link className="text-cyan-800" to="/">
            Login Here
          </Link>
        </p>
      </form>
